...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        Class<?>[] interfeis = someInterfaceWithMethods.getClass().getInterfaces();
        CustomInvocationHandler customInvocationHandler = new CustomInvocationHandler(someInterfaceWithMethods);
        Proxy p = (Proxy) Proxy.newProxyInstance(classLoader, interfeis, customInvocationHandler);
        return (SomeInterfaceWithMethods) p;
    }
}
