    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            ...
            private int compareDate (Stock stock1, Stock stock2) {
                long dey = 24*60*60*60/1000;
                Long date1 = ((Date) stock1.get("date")).getTime() / dey;
                Long date2 = ((Date) stock2.get("date")).getTime() / dey;
                return date2.compareTo(date1);
            }
            private int compareProfit (Stock stock1, Stock stock2) {
                int prof1 = getProfitPercentage(stock1);
                int prof2 = getProfitPercentage(stock2);
                return prof2 - prof1;
            }
